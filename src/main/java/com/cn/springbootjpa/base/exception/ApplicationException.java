...
public class ApplicationException extends NestedRuntimeException {
	...
	/**
	 * <p>
	 * Constructs a application exception with specified exception code, an array of
	 ...
	 */
	@Deprecated
	public ApplicationException(String code, String[] params, String defaultMessage, Throwable cause) {
